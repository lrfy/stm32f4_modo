...
#ifndef LCD_TFT_8080_H_
#define LCD_TFT_8080_H_

#define Bank1_LCD_D     ((uint32_t)0x60020000)     //disp Data ADDR
#define Bank1_LCD_R     ((uint32_t)0x60000000)     //disp Reg  ADDR

#define LCD_WR_REG(index) *(vu16*)((uint32_t)0x60000000)=(u16)index
#define LCD_WR_DATA(index) *(vu16*)((uint32_t)0x60020000)=(u16)index
...
void delay_ms(u8 data);
void LCD_Init_color(void);
void LCD_DisplayOn(void);
void LCD_DisplayOff(void);
void LCD_SetCursor(u16 Xpos, u16 Ypos);
//void LCD_WR_DATA(unsigned int index);
